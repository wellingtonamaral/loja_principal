...
import 'package:loja_principal/models/address.dart';
import 'package:loja_principal/models/cart_product.dart';
...
import 'package:loja_principal/services/cepaberto_service.dart';
...
class CartManager extends ChangeNotifier {
  ...
  Future<void> _loadCartItems() async {
    final QuerySnapshot cartSnap = await user.cartRefrence.getDocuments();
  ...
  void removeOfCart(CartProduct cartProduct) {
    ...
    user.cartRefrence.document(cartProduct.id).delete();
